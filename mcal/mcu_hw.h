...
#define APINT_REG    (*((volatile uint32*)0xE000ED0C))

#define NVIC_REG    (*((volatile NVIC_TagType*)0xE000E100))
#define NVIC_Base                                       (0xE000E000)
#define NVIC_Interrupt_Enable_Offset                    (0x100)
#define NVIC_Interrupt_Priority_Offset                  (0x400)
...
typedef struct
{
    ...
    uint32 B30:1;
    uint32 B31:1;
}general_bit_field_Type;

typedef union
{
    uint32                  R;
    general_bit_field_Type  B;
}general_struct_bit_field_Type;

typedef struct
{
    general_struct_bit_field_Type EN0 ;
    general_struct_bit_field_Type EN1 ;
    general_struct_bit_field_Type EN2 ;
    general_struct_bit_field_Type EN3 ;
    general_struct_bit_field_Type EN4 ;
}NVIC_TagType;
